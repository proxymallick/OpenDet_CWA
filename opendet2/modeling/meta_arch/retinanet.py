...
from ..losses import AnchorwCrossEntropyLoss
...
class OpenSetRetinaNet(RetinaNet):
    ...
    def __init__(
        ...
        **kargs,
        ...
        self.num_known_classes = num_known_classes
        self.ins_con_loss = ICLoss(tau=ins_con_queue_tau,num_known_classes = self.num_known_classes)
    ...
    def losses(self, anchors, pred_logits, pred_mlp_feats, gt_labels, pred_anchor_deltas, gt_boxes, gt_ious):
        ...
        loss_anchor = self.get_anchor_loss(cat(pred_logits, dim=1)[
                                       valid_mask], gt_labels[valid_mask])
