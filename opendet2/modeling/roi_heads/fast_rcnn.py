...
#from detectron2.structures.boxes import matched_pairwise_iou #matched_boxlist_iou
#  fast_rcnn_inference)
...
class CosineFastRCNNOutputLayers(FastRCNNOutputLayers):
    ...
    def __init__(
        ...
        **kargs,
        ...
        self.cls_score = spectral_norm( nn.Linear(self.cls_score.in_features, self.num_classes + 1, bias=False))
...
class OpenDetFastRCNNOutputLayers(CosineFastRCNNOutputLayers):
    ...
    def __init__(
        ...
        **kargs
        ...
        self.ic_loss_loss = ICLoss(tau=ic_loss_queue_tau,num_known_classes = self.num_known_classes)
        self.anchor_loss = AnchorwCrossEntropyLoss(loss_weight=0.1, anchor_weight = 0.017, num_classes = self.num_classes)
    ...
    def get_ic_loss(self, feat, gt_classes, ious,scores):
        ...
        loss_ic_loss = self.ic_loss_loss(feat, gt_classes, queue, queue_label,scores,all_gt_classes)
        # loss decay
        storage = get_event_storage()
